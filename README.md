...
---
## [Detail Requirement Analysis](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/requirements)


## [User Stories](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/user-story)


## [Architecture](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/architecture)


## [Database](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/database)


## [Sequence Diagram](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/sequence)


## [UI UX Mockups](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs/ui-mockups)
...
[ ## Repository : calculator-domain-logic](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/calculator-domain-logic/docs)


,[ ## Repository : docs-site](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/docs-site/docs)


,[ ## Repository : formula-execution-service](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/formula-execution-service/docs)


,[ ## Repository : frontend-app](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/frontend-app/docs)


,[ ## Repository : frontend-utils](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/frontend-utils/docs)


,[ ## Repository : infrastructure-as-code](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/infrastructure-as-code/docs)


,[ ## Repository : shared-api-contracts](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/shared-api-contracts/docs)


,[ ## Repository : shared-build-config](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/shared-build-config/docs)


,[ ## Repository : ui-components-library](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/ui-components-library/docs)


,[ ## Repository : user-data-service](https://github.com/TheSSSAI/Electronics-Engineers-Advanced-Calculator/tree/main/user-data-service/docs)
